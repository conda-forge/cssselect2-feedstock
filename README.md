...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cssselect2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cssselect2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install cssselect2
```
...
It is possible to list all of the versions of `cssselect2` available on your platform:
...
```
pixi search cssselect2 --channel conda-forge
```
